...
/**
 * Main WhoooCommerce Class.
 *
 * @class WoooCommerce
 */
final class WhoooCommerce{

	/**
	 * WhoooCommerce version.
	 *
	 * @var string
	 */
	 ...
	 *
	 * Ensures only one instance of WhooCommerce is loaded or can be loaded.
	 *
	 * @since 2.1
	 * @static
	 * @see WC()
	...
	private function define_tables() {
		...
		$tables = array(
			'payment_tokenmeta'      => 'whoocommerce_payment_tokenmeta',
			'order_itemmeta'         => 'whoocommerce_order_itemmeta',
